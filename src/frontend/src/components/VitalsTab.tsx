    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor your health measurements over time
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setVitalForm({ ...vitalForm, heartRate: e.target.value })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setVitalForm({ ...vitalForm, bloodSugar: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setVitalForm({ ...vitalForm, spo2: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your vital measurements over the past 5 days (sample data)
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-80">
