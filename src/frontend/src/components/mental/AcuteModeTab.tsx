...
import { AlertCircle, Coffee, Moon, Users, Wind } from "lucide-react";
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                If you're in crisis, visit the Crisis Safety tab for immediate
                resources.
              </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Guided breathing exercise to calm your nervous system
          </CardDescription>
        </CardHeader>
                ...
                <ol className="space-y-2 text-sm">
                  {protocol.steps.map((step, idx) => (
                    <li key={step} className="flex gap-2">
                      <Badge
                        variant="outline"
                        className="h-6 w-6 shrink-0 items-center justify-center p-0"
                      >
                        {idx + 1}
                      </Badge>
