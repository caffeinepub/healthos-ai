...
import { type GuidanceOutput, generateGuidance } from "./guidanceGenerator";
...
export default function ConditionGuidanceDialog({
  open,
  onOpenChange,
  onOpenModule,
  onNavigateToSettings,
}: ConditionGuidanceDialogProps) {
        ...
        <DialogContent className="max-w-2xl">
          ...
          <Alert>
            <AlertDescription>
              ...
              terms before accessing condition guidance.
            </AlertDescription>
          </Alert>
        </DialogContent>
      </Dialog>
  ...
  const showCrisisResources =
    needsImmediateCrisis(searchInput) || riskAssessment.isHighRisk;
            ...
            <Alert className="mb-4 border-blue-500 bg-blue-50 dark:bg-blue-950/20">
              ...
              <AlertDescription className="text-blue-900 dark:text-blue-100">
                ...
                <p className="text-sm mb-3">
                  Add your age, gender, profession, and future goals to receive
          ...
          {!selectedCondition && !showList && (
            <div className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  This tool provides educational guidance only. It does not
              ...
              <div className="space-y-3">
                <Label htmlFor="condition-search">
                  Search or select a mental health condition
                </Label>
              ...
              {!showCrisisResources && (
                <>
                  <div className="space-y-4">
                    ...
                    {guidance.therapyApproaches.map((approach) => (
                        ...
                        <CardContent className="space-y-4">
                          <div>
                            ...
                            <ul className="text-sm text-muted-foreground space-y-1">
                              {approach.coreTechniques.map((technique) => (
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              {approach.howToStartInApp.map((action) => (
                                <div
                                ...
                                >
                                  ...
                                  {action.moduleId && (
                                    <Button
                                      ...
                                      variant="outline"
                                      onClick={() =>
                                        handleOpenModule(action.moduleId!)
                                      }
                                    >
                                      Start
                                      <ArrowRight className="h-3 w-3 ml-1" />
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <ul className="text-sm text-muted-foreground space-y-2">
                        {guidance.dailyPractices.map((practice) => (
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1">
                          {guidance.nutritionConsiderations.generalPrinciples.map(
                            (principle) => (
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1">
                          {guidance.nutritionConsiderations.specificNutrients.map(
                            (nutrient) => (
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1">
                          {guidance.nutritionConsiderations.avoidOrMonitor.map(
                            (item) => (
                              <li key={item}>• {item}</li>
                            ),
                          )}
