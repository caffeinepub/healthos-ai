  ...
  return (
    <Card className="border-amber-200 dark:border-amber-900/50">
      ...
      <CardContent className="space-y-3 text-sm">
        <Alert>
          <AlertDescription>
            <strong>This is not therapy:</strong> These are self-guided
            educational tools based on evidence-based therapeutic frameworks.
            They are not a substitute for professional mental health care,
            diagnosis, or treatment.
          </AlertDescription>
        </Alert>
        <p>
          <strong>Self-help only:</strong> All modules are designed for
          self-exploration and skill-building. If you need clinical support,
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs">
              ...
              <p className="text-red-800 dark:text-red-300">
                If you're in crisis, call 988 (Suicide & Crisis Lifeline) or
