...
export const THERAPY_LAYERS: TherapyLayerInfo[] = [
  {
    ...
    description:
      "Foundation for safety, grounding, and basic emotional regulation",
    order: 1,
    color: "blue",
  },
  {
    ...
    description:
      "Evidence-based interventions to reduce anxiety, depression, and stress",
    order: 2,
    color: "green",
  },
  {
  ...
  stabilization: [
    {
      ...
      description: "Emergency contacts and coping strategies",
    },
    {
      id: "grounding",
      name: "Grounding Techniques",
      description: "Trauma-informed stabilization exercises",
    },
    {
      id: "sleep-tracking",
      name: "Sleep Tracking",
  ...
  "symptom-reduction": [
    {
      ...
      description: "PHQ-9, GAD-7, and burnout screening",
    },
    {
      id: "cbt-journal",
      name: "CBT Journal",
      description: "Cognitive distortion identification and reframing",
    },
    {
      id: "daily-tracking",
      name: "Daily Mood Tracking",
      description: "Log emotions, stress, and energy levels",
    },
  ],
  "behavioral-restructuring": [
    {
      ...
      description: "Activity scheduling and avoidance mapping",
    },
    {
      id: "habit-reversal",
      name: "Habit Reversal",
      description: "Break impulse patterns and build replacements",
    },
    {
      id: "interventions",
      name: "Active Interventions",
      description: "Track ongoing therapeutic exercises",
    },
  ],
  "psychological-flexibility": [
    {
      id: "act-modules",
      name: "ACT Exercises",
      description: "Values clarification and committed action",
    },
    {
      id: "mindfulness",
      name: "Mindfulness Practice",
      description: "MBCT-based meditation and awareness",
    },
    {
      id: "dbt-skills",
      name: "DBT Skills",
  ...
  "long-term-growth": [
    {
      ...
      description: "Track trends and forecast risk",
    },
    {
      id: "performance-psych",
      name: "Performance Psychology",
      description: "Mental rehearsal and attention control (Optional)",
    },
    {
      id: "burnout-recovery",
      name: "Burnout Recovery",
      description: "4-phase recovery protocol (Optional)",
    },
  ],
};
