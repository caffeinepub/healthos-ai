...
export function parseAge(ageString: string): bigint | undefined {
  ...
  const ageNum = Number.parseInt(trimmed, 10);
...
export function formValueToProfession(
  value: string,
  otherText = "",
): Profession {
  switch (value) {
...
export function professionToFormValue(profession: Profession): {
  value: string;
  otherText: string;
} {
  if (profession.__kind__ === "student")
    return { value: "student", otherText: "" };
  if (profession.__kind__ === "softwareEngineer")
    return { value: "softwareEngineer", otherText: "" };
  if (profession.__kind__ === "doctor")
    return { value: "doctor", otherText: "" };
  if (profession.__kind__ === "nurse") return { value: "nurse", otherText: "" };
  if (profession.__kind__ === "teacher")
    return { value: "teacher", otherText: "" };
  if (profession.__kind__ === "artist")
    return { value: "artist", otherText: "" };
  if (profession.__kind__ === "musician")
    return { value: "musician", otherText: "" };
  if (profession.__kind__ === "designer")
    return { value: "designer", otherText: "" };
  if (profession.__kind__ === "scientist")
    return { value: "scientist", otherText: "" };
  if (profession.__kind__ === "other")
    return { value: "other", otherText: profession.other };
